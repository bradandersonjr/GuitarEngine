...
defaultFretboardLength = adsk.core.TextBoxCommandInput.cast(None)
...
def run(context):
    try:
        ...
        cmdDef = ui.commandDefinitions.addButtonDefinition('adskFretboardPythonAddIn', 'Guitar Engine [Beta] (v2019.01.20)', 'Creates a fretboard component\n\n', 'Resources/Icons')        
        ...
        if context['IsApplicationStartup'] == False:
            ui.messageBox('<b>Guitar Engine [Beta] (v2019.01.20)</b> has been added to the <i>SOLID</i> tab of the <i>DESIGN</i> workspace.<br><br><div align="center"><b>This is a beta version.</div>')
    except:
        if ui:
...
#            cmd.setDialogMinimumSize(180, 800)
            ...
            defaultFretboardLength = tab1ChildInputs.addTextBoxCommandInput('length_textBox', 'Fretboard Length', units, 2, True)
    ...
    def notify(self, args):
        try:
            ...
            dimsComp = guitarDimensions(design, fretNumber, scaleLength, nutLength, endLength, nutRadius, endRadius, height, filletRadius, endCurve, tangWidth, bridgeStringSpacing, tangDepth,
                                        ...
                                        machinePostHoleSpacing, machinePostHoleDiameter, machinePostDiameter, nutStringSpacing)
...
def buildFretboard(design, fretNumber, scaleLength, nutLength, endLength, nutRadius, endRadius, height, filletRadius, endCurve, tangWidth, tangDepth, crownWidth, crownHeight, blindFrets, 
                   nutSlotWidth, nutSlotDepth, markerDiameter, markerDepth, markerSpacing, guitarLength, headstockLength):
    try:
...
#
        ...
        if createFilletRadius.value:
            ...
            fretboardSurf = fretboardFaces[5::2]
#            
